...
global.channelLink = "https://whatsapp.com/channel/0029Vb6RoNb0bIdgZPwcst2Y";
global.ytch = "Mr Admin Blue";
    ...
    try {
        ...
        if (message.message?.buttonsResponseMessage) {
            ...
            if (buttonId === 'channel') {
                ...
                await sock.sendMessage(chatId, {
                    text: `🔗 *Support*\n\nhttps://chat.whatsapp.com/L3Ffs0kD6xj3zRb2lExrC7`
                }, { quoted: message });
                return;
            }
        }
        ...
        const ownerCommands = ['.mode', '.autostatus', '.antidelete', '.cleartmp', '.setpp', '.clearsession', '.areact', '.autoreact', '.autotyping', '.autoread', '.pmblocker', '.tagall','.tagnotadmin', '.hidetag'];
